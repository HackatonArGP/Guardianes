...
namespace EarthWatchers.SL.Requests
{
    public class CommentRequests
    {
        ...
        public void Delete(int commentId, string username, string password)
        {
            client.Authenticator = new HttpBasicAuthenticator(username, password);
            var request = new RestRequest(@"comments/"+ commentId.ToString(CultureInfo.InvariantCulture), Method.DELETE);
