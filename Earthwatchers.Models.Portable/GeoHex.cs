...
namespace Earthwatchers.Models
{
    public class GeoHex
    {
	    ...
	    private static Zone GetZoneByLocation(double lon, double lat, int level) 
        {
		    ...
		    Location z_loc = Calculations.XyToLoc(h_lon, h_lat);
	    ...
	    private static Zone GetZoneByCode(String code) 
        {
		    ...
		    Location h_loc = Calculations.XyToLoc(h_lon_x, h_lat_y);
		    ...
		    return new Zone(h_loc.Latitude, h_loc.Longitude, h_x, h_y, code);
	    }
